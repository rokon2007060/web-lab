...
<body>
    ...
    <section class="container1" id="about">
        <div class="edit-button">
            <button onclick="editSection('about',document.getElementById('about').innerHTML)">Edit</button>
        </div>
        <h2>About Me:</h2>
        <div class="about-content">
            <div class="edit-button">
                <button onclick="editSection('family',document.getElementById('family').innerHTML)">Edit</button>
            </div>
            <p class="fade-in" id="family">
            ...
            <div class="edit-button">
                <button onclick="editSection('academic',document.getElementById('academic').innerHTML)">Edit</button>
            </div>
            <p class="fade-in" id="Academic">
    ...
    <div class="edit-button container1">
            <button onclick="editSection('skill',document.getElementById('skill').innerHTML)">Edit</button>
    </div>
    ...
    <div class="edit-button container1">
            <button onclick="editSection('project',document.getElementById('project').innerHTML)">Edit</button>
    </div>
    ...
    <section class="container1 message-section" id="message">
        <div class="edit-button">
            <button onclick="editSection('message',document.getElementById('message').innerHTML)">Edit</button>
        </div>
    ...
    <section class="container1 contact-section" id="contact">
        ...
        <div class="contact-content">
            <p>
                📞 Phone Numbers:<br>
                <div class="edit-button">
                    <button onclick="editSection('phone1',document.getElementById('phone1').innerHTML)">Edit</button>
                </div>
                <span class="phone-number" id="phone1">017XXXXXXX</span><br>
                <div class="edit-button">
                    <button onclick="editSection('phone2',document.getElementById('phone2').innerHTML)">Edit</button>
                </div>
                <span class="phone-number" id="phone2">015XXXXXXX</span>
            </p>
            <p>
                <div class="edit-button">
                    <button onclick="editSection('email',document.getElementById('email').innerHTML)">Edit</button>
                </div>
                ✉ Email:<br>
                <span class="email" id="email">asrkn3789@gmail.com</span>
            </p>
            <p>
                <div class="edit-button">
                    <button onclick="editSection('landline',document.getElementById('landline').innerHTML)">Edit</button>
                </div>
                ☎ Landline:<br>
                <span class="landline" id="landline">2344 7337</span>
            </p>
        </div>
    </section>
    <hr class="separator-line">
    <section class="container1 copyright-section" id="copyright" >
        <div class="edit-button">
            <button onclick="editSection('copyright',document.getElementById('copyright').innerHTML)">Edit</button>
        </div>
    ...
    <div id="editModal">
        <div class="modal-content">
            ...
            <form id="editForm">
                ...
                <textarea id="editedContent" name="editedContent"></textarea>
